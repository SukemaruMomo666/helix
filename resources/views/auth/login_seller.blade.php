...
<head>
    ...
    <title>Seller Login - Helix Seller Centre</title>
...
<body class="bg-white font-sans text-zinc-900 antialiased flex min-h-screen overflow-hidden">
    ...
    <div class="hidden lg:flex w-1/2 bg-zinc-950 relative items-center justify-center overflow-hidden p-12 z-0">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none z-0 mix-blend-screen">
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] transform-gpu">
                <div class="absolute top-10 left-10 w-[400px] h-[400px] bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500/20 rounded-full blur-[100px] animate-blob transform-gpu"></div>
                <div class="absolute bottom-10 right-10 w-[500px] h-[500px] bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500/20 rounded-full blur-[120px] animate-blob-reverse transform-gpu" style="animation-delay: -5s;"></div>
            </div>
        </div>
        ...
        <div class="relative z-20 w-full max-w-lg animate-fade-in-up">
            ...
            <div class="mb-10 inline-flex items-center justify-center p-3 glass-panel rounded-2xl shadow-2xl transform hover:scale-105 transition-transform duration-500">
                <img src="{{ asset('assets/image/Helix.com.png') }}" alt="Logo" class="h-10 w-auto object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]" onerror="this.outerHTML='<div class=\'text-white font-black text-2xl px-2\'>P<span class=\'text-emerald-600\'>.</span> Seller</div>'">
            </div>

            <h1 class="text-5xl font-black text-white leading-[1.1] tracking-tight mb-6">
                Pusat Kendali<br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-blue-400 to-orange-400">Bisnis Produk Anda.</span>
            </h1>

            <p class="text-zinc-400 text-lg font-medium leading-relaxed mb-12">
                Kelola inventaris, pantau analitik penjualan secara real-time, dan jangkau ribuan pembeli UMKM di seluruh Indonesia hanya dari satu dashboard.
            </p>
        ...
        <div class="w-full max-w-md animate-fade-in-up" style="animation-delay: 0.1s;">
            ...
            <div class="lg:hidden flex items-start justify-between mb-10 pt-2">
                ...
                <div class="text-right">
                    <img src="{{ asset('assets/image/Helix.com.png') }}" alt="Logo" class="h-8 w-auto inline-block object-contain" onerror="this.outerHTML='<div class=\'text-black font-black text-2xl tracking-tight\'>Helix<span class=\'text-emerald-600\'>.</span></div>'">
            ...
            <div class="mb-10">
                <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-100 text-zinc-700 text-[10px] font-black uppercase tracking-widest mb-4 border border-zinc-200">
                    <i class="fas fa-store text-emerald-600"></i> Portal Penjual
                </div>
                <h2 class="text-3xl font-black text-black tracking-tight mb-2">Akses Toko Anda</h2>
                <p class="text-zinc-500 font-medium text-sm">
                    Ingin mulai berjualan? <a href="{{ route('seller.register') }}" class="text-emerald-600 font-bold hover:underline transition-all">Daftar sebagai Penjual</a>
                </p>
            </div>
            ...
            <form action="{{ route('seller.login.process') }}" method="POST" id="sellerLoginForm" class="space-y-5">
                ...
                <div class="relative group">
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i class="fas fa-user text-zinc-400 group-focus-within:text-emerald-600 transition-colors"></i>
                        </div>
                ...
                <div class="flex items-center justify-between pt-1">
                    ...
                    <a href="{{ url('/lupa-password') }}" class="text-xs font-bold text-zinc-500 hover:text-emerald-600 transition-colors">Lupa Sandi?</a>
                </div>

                {{-- Submit Button --}}
                <button type="submit" id="btnSubmit" class="w-full bg-black hover:bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 text-white font-black py-4 rounded-2xl transition-all duration-300 shadow-[0_8px_20px_rgba(0,0,0,0.15)] hover:shadow-[0_12px_30px_rgba(37,99,235,0.3)] hover:-translate-y-1 hover:scale-[1.01] mt-6 flex items-center justify-center gap-2">
    ...
    <script>
        ...
        document.getElementById('sellerLoginForm').addEventListener('submit', function() {
            ...
            btn.classList.remove('hover:-translate-y-1', 'hover:scale-[1.01]', 'hover:bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500');
        });
