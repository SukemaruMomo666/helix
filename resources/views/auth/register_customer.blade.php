...
<body class="bg-white font-sans text-zinc-900 antialiased flex flex-col lg:flex-row-reverse min-h-screen overflow-hidden relative">
    ...
    <div class="hidden lg:flex w-1/2 bg-[#09090b] relative items-center justify-center overflow-hidden p-12">
        ...
        <div class="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
            ...
            <div class="absolute bottom-0 left-0 w-[400px] h-[400px] bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500/20 rounded-full blur-[100px] animate-blob" style="animation-delay: 1.5s;"></div>
        ...
        <div class="relative z-10 w-full max-w-lg animate-fade-in-up">
            <h1 class="text-5xl font-black text-white leading-[1.1] tracking-tight mb-6">
                Mulailah Jelajahi<br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-blue-400 to-orange-400">Produk Lokal Terbaik.</span>
            </h1>
            ...
            <div class="space-y-4">
                <div class="bg-white/5 border border-white/10 backdrop-blur-md p-5 rounded-2xl flex items-center gap-4 transition-transform hover:-translate-y-1">
                    ...
                    <div><h4 class="text-white font-bold text-sm">Harga Terbaik</h4></div>
                </div>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative overflow-y-auto h-screen custom-scrollbar">
        ...
        <div class="w-full max-w-md my-auto animate-fade-in-up pb-10">
            ...
            <div class="lg:hidden flex items-center justify-between mb-8 pt-2">
                ...
                <img src="{{ asset('logohelix.png') }}" alt="Logo" class="h-8 w-auto object-contain">
            </div>
            ...
            <div class="mb-8 mt-4 lg:mt-0">
                ...
                <p class="text-zinc-500 font-medium text-sm">
                    Sudah tergabung? <a href="{{ route('login') }}" class="text-emerald-600 font-bold hover:underline transition-all">Masuk di sini</a>
                </p>
            </div>
            ...
            <form action="{{ route('register.process') }}" method="POST" id="registerForm" class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="relative group">
                        ...
                        <input type="text" name="username" class="w-full bg-zinc-50 border border-zinc-200 text-black text-sm font-semibold rounded-2xl focus:bg-white focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 block px-4 py-3.5 transition-all outline-none placeholder:text-zinc-400" placeholder="johndoe" value="{{ old('username') }}" required>
                    </div>
                    <div class="relative group">
                        <label class="block text-[10px] font-black text-zinc-400 uppercase tracking-widest mb-1.5 ml-1">Nama Lengkap</label>
                        <input type="text" name="nama" class="w-full bg-zinc-50 border border-zinc-200 text-black text-sm font-semibold rounded-2xl focus:bg-white focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 block px-4 py-3.5 transition-all outline-none placeholder:text-zinc-400" placeholder="John Doe" value="{{ old('nama') }}" required>
                    </div>
                </div>
                ...
                <div class="relative group">
                    ...
                    <div class="relative flex">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none"><i class="fas fa-envelope text-zinc-400 group-focus-within:text-emerald-600 transition-colors"></i></div>
                        <input type="email" id="emailInput" name="email" class="w-full bg-zinc-50 border border-zinc-200 text-black text-sm font-semibold rounded-2xl focus:bg-white focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 block pl-11 pr-[100px] py-3.5 transition-all outline-none placeholder:text-zinc-400" placeholder="john@perusahaan.com" value="{{ old('email') }}" required>
                        
                        <button type="button" id="btnSendOtp" onclick="sendOtp()" class="absolute right-1 top-1 bottom-1 px-4 bg-zinc-900 text-white rounded-xl font-bold text-xs hover:bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 transition-colors flex items-center justify-center min-w-[90px]">
                ...
                <div id="otpContainer" class="relative group hidden mt-4">
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none"><i class="fas fa-shield-alt text-zinc-400 group-focus-within:text-emerald-600 transition-colors"></i></div>
                        <input type="text" name="otp" id="otpInput" class="w-full bg-zinc-50 border border-zinc-200 text-black text-sm font-semibold rounded-2xl focus:bg-white focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 block pl-11 py-3.5 transition-all outline-none placeholder:text-zinc-400" placeholder="Masukkan 6 digit angka" maxlength="6" {{ old('otp') ? 'required' : '' }} value="{{ old('otp') }}">
                    </div>
                ...
                <div class="relative group">
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i class="fas fa-lock text-zinc-400 group-focus-within:text-emerald-600 transition-colors"></i>
                        </div>
                        <input type="password" name="password" id="reg-password" oninput="cekKekuatanSandi(); cekKecocokanSandi()" class="w-full bg-zinc-50 border border-zinc-200 text-black text-sm font-semibold rounded-2xl focus:bg-white focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 block pl-11 pr-12 py-3.5 transition-all outline-none placeholder:text-zinc-400" placeholder="Minimal 8 karakter" required>
                ...
                <div class="relative group">
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                            <i id="icon-conf" class="fas fa-shield-alt text-zinc-400 group-focus-within:text-emerald-600 transition-colors"></i>
                        </div>
                        <input type="password" name="password_confirmation" id="reg-password-conf" oninput="cekKecocokanSandi()" class="w-full bg-zinc-50 border border-zinc-200 text-black text-sm font-semibold rounded-2xl focus:bg-white focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 block pl-11 pr-12 py-3.5 transition-all outline-none placeholder:text-zinc-400" placeholder="Ulangi kata sandi" required>
                ...
                <div class="mt-6 border-2 border-dashed border-zinc-200 bg-zinc-50 hover:bg-blue-50/50 hover:border-blue-300 rounded-2xl p-4 flex items-center justify-between cursor-pointer transition-colors group" onclick="openTncModal()">
                    <div class="flex items-center gap-3">
                        <div class="relative flex items-center justify-center shrink-0">
                            ...
                            {{-- Visual Checkbox --}}
                            <div class="w-5 h-5 rounded-md border-2 border-zinc-300 peer-checked:bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 peer-checked:border-blue-600 flex items-center justify-center transition-all group-hover:border-blue-400">
    ...
    <div id="tnc-modal" class="fixed inset-0 bg-zinc-950/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 opacity-0 pointer-events-none transition-opacity duration-300">
        <div class="w-full max-w-2xl bg-white rounded-[2rem] shadow-2xl flex flex-col overflow-hidden max-h-[90vh] transform scale-95 transition-transform duration-300" id="tnc-modal-content">
            ...
            <div class="px-6 py-5 border-b border-zinc-100 flex items-center justify-between bg-zinc-50">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 bg-blue-100 text-emerald-600 rounded-xl flex items-center justify-center">
            ...
            <div class="relative flex-1 overflow-hidden bg-white">
                ...
                <div id="tnc-text-area" class="h-full overflow-y-auto tnc-scrollbar p-6 md:p-8 text-sm text-zinc-600 leading-relaxed space-y-6">
                    ...
                    <p>Selamat datang di Helix. Dengan mendaftar dan menggunakan layanan e-commerce Helix, Anda secara otomatis menyetujui seluruh syarat dan ketentuan yang berlaku di bawah ini. Harap membaca dengan saksama sebelum melanjutkan proses pendaftaran akun Anda.</p>
                    
                    <h2 class="text-base font-black text-black">2. Akun dan Keamanan</h2>
                    <p>a. Anda bertanggung jawab penuh untuk menjaga kerahasiaan kata sandi akun Anda.<br>b. Helix tidak bertanggung jawab atas kerugian yang ditimbulkan akibat kelalaian pengguna dalam menjaga akses akun.<br>c. Setiap akun yang didaftarkan harus mewakili pembeli yang sah.</p>

                    <h2 class="text-base font-black text-black">3. Transaksi dan Pembayaran</h2>
                    <p>a. Segala bentuk transaksi jual beli material wajib dilakukan melalui sistem pembayaran resmi yang disediakan oleh Helix.<br>b. Transaksi di luar sistem (*bypass*) merupakan pelanggaran berat dan dapat mengakibatkan pemblokiran akun secara permanen.<br>c. Harga yang tertera pada katalog belum termasuk PPN, kecuali jika dijelaskan sebaliknya pada halaman detail tagihan.</p>

                    <h2 class="text-base font-black text-black">4. Pengiriman Material</h2>
                    <p>a. Estimasi pengiriman disesuaikan dengan ketersediaan armada dan jadwal rute dari masing-masing Mitra/Toko.<br>b. Pembeli wajib memastikan akses jalan menuju lokasi pengiriman dapat dilalui oleh armada truk yang bersangkutan.</p>

                    <h2 class="text-base font-black text-black">5. Kebijakan Retur (Pengembalian Barang)</h2>
                    <p>Barang yang sudah dibeli dan diterima sesuai dengan surat jalan tidak dapat dikembalikan, kecuali terdapat cacat pabrik atau kesalahan spesifikasi dari pihak pengirim yang dilaporkan maksimal 1x24 jam sejak barang tiba di lokasi pengiriman.</p>
            ...
            <div class="p-6 border-t border-zinc-100 bg-zinc-50 flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <button type="button" id="btn-modal-submit" disabled onclick="acceptTnc()" class="w-full sm:w-auto bg-zinc-900 text-white font-black py-3 px-8 rounded-xl transition-all disabled:bg-zinc-200 disabled:text-zinc-400 disabled:cursor-not-allowed enabled:hover:bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 enabled:hover:-translate-y-0.5">
                    Setuju & Tutup
                </button>
            </div>
        </div>
    ...
    <script>
        ...
        function cekKecocokanSandi() {
            ...
            conf.classList.remove('border-zinc-200', 'focus:border-emerald-500', 'focus:ring-emerald-500/10', 'border-red-500', 'focus:border-red-500', 'focus:ring-red-500/10', 'border-emerald-500', 'focus:border-emerald-500', 'focus:ring-emerald-500/10');
            iconConf.classList.remove('text-zinc-400', 'group-focus-within:text-emerald-600', 'text-red-500', 'text-emerald-500');

            if (confVal === '') {
                conf.classList.add('border-zinc-200', 'focus:border-emerald-500', 'focus:ring-emerald-500/10');
                iconConf.classList.add('text-zinc-400', 'group-focus-within:text-emerald-600');
