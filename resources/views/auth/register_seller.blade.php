...
<head>
    ...
    <title>Buka Toko - Helix Enterprise</title>
...
<body class="bg-white font-sans text-zinc-900 antialiased flex flex-col lg:flex-row min-h-screen overflow-hidden">
    ...
    <div class="hidden lg:flex w-5/12 bg-zinc-950 relative flex-col justify-between p-12 z-0">
        ...
        {{-- Tombol Back Desktop --}}
        <a href="{{ url('/') }}" class="absolute top-8 left-12 z-50 flex items-center justify-center w-12 h-12 bg-white/10 border border-white/20 text-white rounded-full hover:bg-white/20 active:scale-95 transition-all shadow-lg backdrop-blur-md group">
            <i class="fas fa-arrow-left group-hover:-translate-x-1 transition-transform"></i>
        </a>

        {{-- Ambient Light FX --}}
        <div class="absolute inset-0 overflow-hidden pointer-events-none z-0 mix-blend-screen">
            <div class="absolute top-0 left-0 w-[600px] h-[600px] bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500/20 rounded-full blur-[120px] -translate-x-1/2 -translate-y-1/2"></div>
            <div class="absolute bottom-0 right-0 w-[500px] h-[500px] bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500/20 rounded-full blur-[100px] translate-x-1/3 translate-y-1/3"></div>
        </div>
        ...
        <div class="relative z-20 animate-fade-in-up">
            <a href="{{ url('/') }}" class="inline-flex items-center justify-center p-3 glass-panel rounded-2xl shadow-2xl hover:scale-105 transition-transform duration-500 mb-12">
                <img src="{{ asset('assets/image/Helix.com.png') }}" alt="Logo" class="h-8 w-auto object-contain drop-shadow-md" onerror="this.outerHTML='<div class=\'text-white font-black text-xl px-2\'>P<span class=\'text-emerald-600\'>.</span></div>'">
            </a>

            <h1 class="text-4xl xl:text-5xl font-black text-white leading-[1.1] tracking-tight mb-6">
                Ekspansi Bisnis<br>Produk Anda<br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 via-blue-400 to-orange-400">Dimulai Dari Sini.</span>
            </h1>

            <p class="text-zinc-400 text-base font-medium leading-relaxed max-w-sm mb-12">
                Bergabunglah dengan ekosistem UMKM terbesar. Capai ribuan pembeli, kelola pesanan digital, dan pantau logistik dalam satu platform pintar.
            </p>
            ...
            <div class="space-y-4">
                <div class="glass-panel p-4 rounded-2xl flex items-center gap-4">
                    ...
                    <div>
                        <h4 class="text-white font-bold text-sm">Akses Pasar UMKM</h4>
                    </div>
                </div>
                <div class="glass-panel p-4 rounded-2xl flex items-center gap-4">
                    <div class="w-10 h-10 rounded-xl bg-emerald-500/20 text-emerald-400 flex items-center justify-center shrink-0 border border-emerald-500/20">
    ...
    <div class="w-full lg:w-7/12 overflow-y-auto h-screen custom-scrollbar relative bg-white z-10 shadow-[-20px_0_40px_rgba(0,0,0,0.05)]">
        <div class="p-6 sm:p-12 lg:p-16 max-w-2xl mx-auto animate-fade-in-up">
            ...
            <div class="lg:hidden flex items-center justify-between mb-8 pt-2">
                ...
                <img src="{{ asset('assets/image/Helix.com.png') }}" alt="Logo" class="h-8 w-auto object-contain" onerror="this.outerHTML='<div class=\'text-black font-black text-2xl tracking-tight\'>Helix<span class=\'text-emerald-600\'>.</span></div>'">
            </div>
            ...
            <div class="mb-10">
                ...
                <p class="text-zinc-500 font-medium text-sm">
                    Sudah memiliki akun toko? <a href="{{ route('seller.login') }}" class="text-emerald-600 font-bold hover:underline transition-all">Masuk ke Dashboard</a>
                </p>
            </div>
            ...
            <form action="{{ route('seller.register.process') }}" method="POST" enctype="multipart/form-data" id="registerSellerForm" class="space-y-10">
                ...
                <div>
                    <div class="flex items-center gap-3 mb-6 border-b border-zinc-100 pb-3">
                        <div class="w-8 h-8 rounded-full bg-emerald-50 text-emerald-600 font-black flex items-center justify-center text-sm">1</div>
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div class="relative group">
                                ...
                                <input type="text" name="username" required value="{{ old('username') }}" placeholder="budiproduk" class="w-full bg-zinc-50 border-2 border-zinc-200 text-black text-sm font-semibold rounded-2xl focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 px-5 py-4 transition-all outline-none lowercase">
                            </div>
                            <div class="relative group">
                ...
                <div>
                    ...
                    <div class="space-y-5">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            <div class="relative group">
                                <label class="block text-[10px] font-black text-zinc-400 uppercase tracking-widest mb-1.5 ml-1">Nama Toko <span class="text-red-500">*</span></label>
                                <input type="text" name="nama_toko" required value="{{ old('nama_toko') }}" placeholder="Toko Berkah UMKM" class="w-full bg-zinc-50 border-2 border-zinc-200 text-black text-sm font-semibold rounded-2xl focus:bg-white focus:border-blue-600 focus:ring-4 focus:ring-blue-600/10 px-5 py-4 transition-all outline-none">
                            </div>
                            <div class="relative group">
                            ...
                            <div class="p-3 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 z-10 relative">
                                <div>
                                    <h2 class="text-base font-black text-black flex items-center gap-2">
                                        <i class="fas fa-map-marked-alt text-emerald-600"></i> Titik Lokasi GPS Toko
                                    </h2>
                                    <p class="text-[11px] text-zinc-500 mt-1 font-medium">Geser pin merah ke lokasi persis gudang produk Anda untuk kurir sistem.</p>
                                </div>
                                <button type="button" onclick="getLocation()" class="shrink-0 bg-zinc-900 hover:bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 text-white font-bold py-2.5 px-4 rounded-xl transition-all text-xs flex items-center justify-center gap-2">
                            ...
                            <div class="relative w-full h-[280px] rounded-[1.5rem] overflow-hidden border-2 border-white shadow-inner bg-zinc-100 z-10">
                                ...
                                <div class="absolute bottom-4 left-4 z-[400] glass-map-panel p-3 rounded-xl shadow-map-overlay">
                                    <div class="text-[10px] font-bold text-zinc-600 flex flex-col gap-0.5">
                                        <div class="flex gap-2"><span>Lat:</span> <span id="lat-display" class="text-emerald-600 font-black">-</span></div>
                                        <div class="flex gap-2"><span>Lng:</span> <span id="lng-display" class="text-emerald-600 font-black">-</span></div>
                                    </div>
                                </div>
                        ...
                        <div class="relative group mt-2">
                            ...
                            <p class="text-[10px] text-zinc-500 mt-2 ml-1 font-medium"><i class="fas fa-info-circle text-emerald-500"></i> Sangat Krusial: Klik nama daerah yang muncul di list dropdown agar sistem ongkos kirim toko Anda berfungsi.</p>
                        </div>

                        {{-- Custom File Upload --}}
                        <div class="relative group mt-4">
                            <label class="block text-[10px] font-black text-zinc-400 uppercase tracking-widest mb-1.5 ml-1">Logo Toko (Opsional)</label>
                            <div class="w-full bg-zinc-50 border-2 border-dashed border-zinc-300 rounded-2xl p-4 flex items-center gap-4 transition-colors hover:border-emerald-500 relative">
                ...
                <div class="pt-4 pb-10">
                    <button type="submit" id="btnSubmit" class="w-full bg-black hover:bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 text-white font-black py-4 rounded-2xl transition-all duration-300 shadow-[0_8px_20px_rgba(0,0,0,0.15)] hover:shadow-glow hover:-translate-y-1 text-base flex items-center justify-center gap-2">
                    ...
                    <p class="text-[10px] text-zinc-400 text-center mt-5 font-medium leading-relaxed max-w-sm mx-auto">
                        Dengan mendaftar, Anda menyetujui Perjanjian Kemitraan dan Kebijakan Privasi Penjual Helix.
                    </p>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.previewImage = function(input) {
                ...
                if (input.files && input.files[0]) {
                    ...
                    reader.onload = function(e) {
                        ...
                        fileName.classList.add('text-emerald-600');
                    }
            ...
            document.getElementById('registerSellerForm').addEventListener('submit', function(e) {
                ...
                setTimeout(() => {
                    ...
                    btn.classList.remove('hover:-translate-y-1', 'hover:bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500', 'hover:shadow-glow');
                }, 10);
            });
            ...
            async function searchBiteshipAreas(keyword) {
                searchIcon.innerHTML = '<i class="fas fa-spinner loader-spin text-emerald-500"></i>';
                try {
                    ...
                    if(data.areas && data.areas.length > 0) {
                        data.areas.forEach(area => {
                            ...
                            li.className = 'px-4 py-3 hover:bg-emerald-50 cursor-pointer border-b border-zinc-100 last:border-0 transition-colors';
                            li.innerHTML = `
