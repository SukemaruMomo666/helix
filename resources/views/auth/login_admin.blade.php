...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/vendors/mdi/css/produkdesignicons.min.css') }}">
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                <a href="{{ url('/') }}" class="brand-link">Helix</a>
            ...
            <div class="login-footer">
                <p>&copy; {{ date('Y') }} Helix. All Rights Reserved.</p>
            </div>
        </div>
    </div>
