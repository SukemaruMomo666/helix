...
<footer class="mt-10 pt-6 pb-8 border-t border-slate-200">
    <div class="flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div class="text-sm font-medium text-slate-500">
            &copy; {{ date('Y') }} <span class="font-black text-slate-800">Helix</span> Seller Center.
        ...
        <div class="flex items-center gap-4 sm:gap-6 text-sm font-bold text-slate-400">
            <a href="#" class="hover:text-emerald-600 transition-colors">Pusat Bantuan</a>
            ...
            <a href="#" class="hover:text-emerald-600 transition-colors hidden sm:block">Syarat & Ketentuan</a>
        </div>
