...
<div class="min-h-screen bg-slate-50 p-4 md:p-6 lg:p-8 font-sans text-slate-900 space-y-6">
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <div>
            ...
            <p class="text-sm font-medium text-slate-500">Kelola permintaan retur produk dan pengembalian dana dari pembeli.</p>
        </div>
    </div>
                ...
                <div class="bg-white border border-slate-200 rounded-3xl overflow-hidden shadow-sm hover:shadow-md hover:border-slate-300 transition-all duration-300">
                    ...
                    <div class="bg-slate-50/50 px-6 py-4 border-b border-slate-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div class="flex flex-wrap items-center gap-3">
                            <span class="font-mono font-black text-emerald-600 flex items-center gap-1.5"><i class="mdi mdi-ticket-confirmation-outline text-lg"></i>{{ $ret->id_return }}</span>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-slate-100">
                        ...
                        {{-- KIRI: Info Produk --}}
                        <div class="p-6">
                            <span class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4">Rincian Produk & Pembeli</span>
    ...
    document.querySelectorAll('.btn-action-reject').forEach(btn => {
        btn.addEventListener('click', function(e) {
            ...
            Swal.fire({
                ...
                text: "Apakah Anda yakin menolak klaim ini? Pastikan Anda telah berdiskusi dengan pembeli mengenai kendala produk.",
                icon: 'warning',
