    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4 relative z-20">
        <div>
            <h1 class="text-2xl lg:text-3xl font-black text-slate-900 tracking-tight flex items-center gap-3">
                <div class="w-10 h-10 bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 text-white rounded-xl flex items-center justify-center shadow-lg shadow-blue-600/20">
    ...
    <div class="bg-white border border-slate-200 rounded-[2rem] shadow-sm overflow-hidden flex flex-col min-h-[700px] relative z-10">
        ...
        <div class="bg-white border-b border-slate-200 px-4 sm:px-8 flex justify-between items-end z-40 sticky top-0">
            <div class="flex gap-6 sm:gap-10 overflow-x-auto hide-scrollbar pt-6 w-full">
                <button type="button" @click.prevent="activeTab = 'halaman_toko'"
                        ...
                        :class="activeTab === 'halaman_toko' ? 'border-blue-600 text-emerald-600' : 'border-transparent text-slate-500 hover:text-slate-800'">
                    Dekorasi Halaman Toko
                </button>
                <button type="button" @click.prevent="activeTab = 'kategori'"
                        class="pb-4 px-1 text-sm sm:text-base font-black transition-all whitespace-nowrap border-b-4 outline-none"
                        :class="activeTab === 'kategori' ? 'border-blue-600 text-emerald-600' : 'border-transparent text-slate-500 hover:text-slate-800'">
                    Halaman Kategori
                </button>
                <button type="button" @click.prevent="activeTab = 'produk_pilihan'"
                        ...
                        :class="activeTab === 'produk_pilihan' ? 'border-blue-600 text-emerald-600' : 'border-transparent text-slate-500 hover:text-slate-800'">
                    Produk Pilihan Toko
                    <i @click.stop="showInfoProdukPilihan()" class="mdi mdi-information text-slate-300 hover:text-emerald-500 text-base font-normal transition-colors cursor-pointer" title="Klik untuk info lebih lanjut"></i>
                </button>
            </div>
        </div>
        ...
        <div x-show="activeTab === 'halaman_toko'" x-transition.opacity.duration.400ms class="flex-1 p-6 md:p-12 relative overflow-hidden">
            ...
            <div class="absolute top-0 right-0 w-full h-full overflow-hidden pointer-events-none z-0">
                <div class="absolute -right-40 -top-40 w-[600px] h-[600px] bg-emerald-50 rounded-full blur-3xl opacity-80"></div>
            ...
            <div class="relative z-20 flex gap-2 p-1.5 bg-slate-100 rounded-xl inline-flex mb-12 border border-slate-200/60 shadow-inner">
                <button type="button" @click="subTab = 'aplikasi'" :class="subTab === 'aplikasi' ? 'bg-white text-emerald-600 shadow-sm border-slate-200' : 'text-slate-500 hover:text-slate-700 border-transparent'" class="px-6 py-2.5 text-sm font-bold rounded-lg border transition-all flex items-center gap-2 outline-none">
                    <i class="mdi mdi-cellphone text-lg leading-none"></i> Aplikasi Mobile
                </button>
                <button type="button" @click="subTab = 'situs'" :class="subTab === 'situs' ? 'bg-white text-emerald-600 shadow-sm border-slate-200' : 'text-slate-500 hover:text-slate-700 border-transparent'" class="px-6 py-2.5 text-sm font-bold rounded-lg border transition-all flex items-center gap-2 outline-none">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-20">
                ...
                <div class="lg:col-span-5 order-2 lg:order-1">
                    ...
                    <h2 class="text-4xl lg:text-5xl font-black text-slate-900 leading-[1.15] mb-6 tracking-tight">
                        Dekorasi tokomu dan dapatkan <span class="text-emerald-600">20%+</span> jumlah pengunjung!
                    </h2>
                ...
                <div class="lg:col-span-7 order-1 lg:order-2 flex justify-center lg:justify-end pointer-events-none relative h-[600px] w-full">
                    ...
                    <div x-show="subTab === 'aplikasi'" 
                        ...
                        <div class="absolute top-24 -left-16 bg-white/90 backdrop-blur px-4 py-2 rounded-2xl shadow-lg border border-slate-100 text-[10px] font-black text-emerald-600 uppercase animate-float z-20">Tampilkan Produk Terbaikmu</div>
                    ...
                    <div x-show="subTab === 'situs'" 
                        ...
                        <div class="absolute -top-4 -right-4 bg-white/90 backdrop-blur px-4 py-2 rounded-xl shadow-lg border border-slate-100 text-[10px] font-black text-emerald-600 uppercase animate-float z-20">Tampilan Ultra Wide</div>
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 h-full relative z-20">
                <div class="lg:col-span-8 bg-white border border-slate-200 rounded-[2rem] shadow-sm p-6 md:p-8 flex flex-col">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
                        ...
                        <div class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-emerald-50 border border-blue-200 text-emerald-600 rounded-lg text-[10px] font-black uppercase tracking-widest">
                            <i class="mdi mdi-auto-fix"></i> Sistem Otomatis Aktif
                        </div>
                    </div>

                    <div class="flex-1 flex flex-col items-center justify-center text-center border-2 border-dashed border-blue-200 rounded-3xl p-10 bg-emerald-50/50">
                        <div class="w-24 h-24 bg-white rounded-full flex items-center justify-center shadow-sm mb-6 border border-blue-100">
                            <i class="mdi mdi-robot-outline text-5xl text-emerald-500"></i>
                        </div>
                        ...
                        <p class="text-sm font-medium text-slate-500 max-w-md mb-8 leading-relaxed">
                            Sistem Helix secara pintar memindai dan mengelompokkan produk jualan Anda berdasarkan <b>Kategori Master</b> (Semen, Besi, Cat, dll). 
                            <br><br>Pembeli dapat langsung memfilter produk di halaman profil toko Anda tanpa perlu pengaturan manual.
                        </p>
                        <button type="button" class="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 text-white text-sm font-bold rounded-xl shadow-sm outline-none cursor-default">
                ...
                <div class="lg:col-span-4 flex flex-col items-center pointer-events-none">
                    ...
                    <div class="w-[260px] h-[520px] bg-slate-900 rounded-[35px] p-2 shadow-xl border-[4px] border-slate-800 relative">
                        ...
                        <div class="w-full h-full bg-slate-50 rounded-[28px] overflow-hidden flex flex-col border border-slate-200">
                            <div class="bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 text-white pt-8 pb-3 px-4 shadow-sm flex items-center gap-3">
                            ...
                            <div class="flex bg-white border-b border-slate-200 shadow-sm">
                                ...
                                <div class="flex-1 py-2.5 text-center text-[10px] font-black text-emerald-600 border-b-2 border-blue-600">Kategori</div>
                            </div>
                        ...
                        <div class="w-full h-full bg-slate-50 rounded-[30px] overflow-hidden flex flex-col border border-slate-200">
                            ...
                            <div class="p-5 flex-1 bg-white">
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <span class="text-[9px] font-bold text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded">See All</span>
                                </div>
                                <div class="grid grid-cols-2 gap-3">
        ...
        <div x-show="isGuideModalOpen"
            ...
            <div class="flex-1 overflow-y-auto p-6 md:p-8 space-y-8">
                <div class="flex gap-4">
                    <div class="w-12 h-12 bg-blue-100 text-emerald-600 rounded-full flex items-center justify-center font-black text-xl flex-shrink-0">1</div>
                    <div>
                ...
                <div class="flex gap-4">
                    <div class="w-12 h-12 bg-blue-100 text-emerald-600 rounded-full flex items-center justify-center font-black text-xl flex-shrink-0">2</div>
                    <div>
                ...
                <div class="flex gap-4">
                    <div class="w-12 h-12 bg-blue-100 text-emerald-600 rounded-full flex items-center justify-center font-black text-xl flex-shrink-0">3</div>
                    <div>
