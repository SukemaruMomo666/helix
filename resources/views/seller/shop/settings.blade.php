        ...
        <div class="lg:col-span-3">
            <div class="bg-white border border-slate-200 rounded-3xl p-3 shadow-sm sticky top-24">
                <nav class="flex flex-col gap-1">
                    <button type="button" onclick="switchTab('general')" id="btn-general" class="tab-btn flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-bold text-blue-700 bg-emerald-50 transition-colors text-left">
            ...
            <form action="{{ route('seller.shop.settings.update') }}" method="POST" id="formGeneral">
                ...
                <div id="tab-notification" class="tab-content space-y-6">
                    <div class="bg-white border border-slate-200 rounded-3xl p-6 md:p-8 shadow-sm">
                        <h3 class="text-base font-black text-slate-900 mb-6 pb-4 border-b border-slate-100 flex items-center gap-2">
                            <i class="mdi mdi-bell-ring-outline text-emerald-500 text-xl"></i> Preferensi Pemberitahuan
                        </h3>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex justify-between items-center gap-4">
                                <div>
                                    ...
                                    <p class="text-xs font-medium text-slate-500">Terima pembaruan berkala dari Helix.</p>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                ...
                <div id="sticky-action-bar" class="fixed bottom-0 left-0 lg:left-[260px] right-0 bg-white/80 backdrop-blur-md border-t border-slate-200 px-6 py-4 flex items-center justify-between z-40 shadow-[0_-10px_15px_-3px_rgba(0,0,0,0.05)]">
                    <div class="hidden sm:block">
                        <p class="text-xs font-bold text-slate-500 m-0"><i class="mdi mdi-information text-emerald-500"></i> Pastikan untuk menyimpan perubahan.</p>
                    </div>
                    <div class="flex gap-3 w-full sm:w-auto">
                        <button type="submit" class="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-2.5 bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 hover:from-emerald-700 hover:via-blue-700 hover:to-orange-600 text-white font-bold rounded-xl shadow-sm shadow-blue-600/20 transition-all btn-save-loader">
...
<script>
    ...
    function switchTab(tabId) {
        ...
        activeBtn.className = 'tab-btn flex items-center gap-3 px-4 py-3 rounded-2xl text-sm font-bold text-blue-700 bg-emerald-50 transition-colors text-left';
