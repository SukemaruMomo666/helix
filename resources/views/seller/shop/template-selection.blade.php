    ...
    <div>
        ...
        <div class="bg-[#1e293b] border-b border-slate-700 h-16 px-4 md:px-8 flex justify-between items-center sticky top-0 z-40 shadow-sm">
            <div class="flex items-center gap-4">
                <div class="w-8 h-8 bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 text-white rounded flex items-center justify-center font-black text-xl shadow-lg shadow-blue-500/30">
            ...
            <div class="flex items-center gap-4">
                <div class="flex items-center gap-2 cursor-pointer hover:bg-slate-800 p-1.5 rounded-lg transition-colors text-white">
                    <div class="w-8 h-8 rounded-full bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 text-white flex items-center justify-center font-black border border-emerald-500">
        ...
        <div class="px-6 lg:px-10 py-8 max-w-[1400px] mx-auto relative z-10">
            ...
            <div class="mb-10">
                <div x-on:click.prevent="blankCanvas()" class="bg-white rounded-2xl border border-slate-200 p-5 flex items-center gap-5 shadow-sm cursor-pointer hover:shadow-md hover:border-blue-400 transition-all group max-w-md">
                    <div class="w-12 h-12 bg-emerald-50 text-emerald-600 group-hover:bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 group-hover:text-white transition-colors rounded-full flex items-center justify-center">
                ...
                @foreach($templates as $tpl)
                    <div class="template-card bg-white rounded-[2rem] border border-slate-200 p-2.5 flex flex-col relative group">
                        ...
                        <div class="absolute inset-0 bg-slate-900/80 backdrop-blur-[2px] opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto flex flex-col items-center justify-center gap-3 px-6 z-30 transition-all duration-300 rounded-[1.5rem]">
                            <button type="button" x-on:click.stop="applyTemplate({{ $tpl['id'] }})" class="transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 delay-75 w-full py-3 bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 hover:bg-emerald-500 text-white text-sm font-bold rounded-xl shadow-xl outline-none">Gunakan Template</button>
                ...
                <div class="iphone-screen bg-white">
                    ...
                    <div class="flex-1 overflow-y-auto hide-scrollbar bg-slate-50 flex flex-col pb-10 relative z-10 pt-2">
                        ...
                        <div class="flex bg-white shadow-sm border-b border-slate-100 z-20 sticky top-0">
                            <div class="flex-1 py-3 text-center text-[12px] font-black border-b-2 border-blue-600 text-emerald-600">Beranda</div>
                        ...
                        <div class="p-3 flex flex-col gap-3">
                            ...
                            <div x-show="hasComp('kategori')" :style="`order: ${getOrder('kategori')}`" class="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
                                <h4 class="text-[12px] font-black text-slate-800 mb-3"><i class="mdi mdi-shape text-emerald-500"></i> Kategori Pilihan</h4>
                            ...
                            <div x-show="hasComp('produk1')" :style="`order: ${getOrder('produk1')}`" class="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 mt-2">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div class="border border-slate-100 rounded-xl p-2 shadow-sm bg-slate-50">
                                        ...
                                        <div class="text-[10px] font-bold text-slate-700 truncate">Produk Unggulan A</div><div class="text-[12px] font-black text-emerald-600 mt-1">Rp 150.000</div>
                                    </div>
                                    <div class="border border-slate-100 rounded-xl p-2 shadow-sm bg-slate-50">
                                        <div class="h-32 bg-white rounded-lg mb-2 flex items-center justify-center border border-slate-100"><i class="mdi mdi-image-outline text-3xl text-slate-300"></i></div>
                                        <div class="text-[10px] font-bold text-slate-700 truncate">Produk Unggulan B</div><div class="text-[12px] font-black text-emerald-600 mt-1">Rp 250.000</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div x-show="hasComp('produk2')" :style="`order: ${getOrder('produk2')}`" class="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
                                <div class="flex justify-between items-center mb-3">
                                    <h4 class="text-[12px] font-black text-slate-800"><i class="mdi mdi-tag text-emerald-500"></i> Pilihan Lainnya</h4>
                                </div>
                                <div class="grid grid-cols-2 gap-3">
                                    <div class="border border-slate-100 rounded-xl p-2 shadow-sm bg-slate-50">
                                        <div class="h-32 bg-white rounded-lg mb-2 flex items-center justify-center border border-slate-100"><i class="mdi mdi-image-outline text-3xl text-slate-300"></i></div>
                                        <div class="text-[10px] font-bold text-slate-700 truncate">Produk Regular C</div><div class="text-[12px] font-black text-emerald-600 mt-1">Rp 99.000</div>
                                    </div>
                                    <div class="border border-slate-100 rounded-xl p-2 shadow-sm bg-slate-50">
                                        <div class="h-32 bg-white rounded-lg mb-2 flex items-center justify-center border border-slate-100"><i class="mdi mdi-image-outline text-3xl text-slate-300"></i></div>
                                        <div class="text-[10px] font-bold text-slate-700 truncate">Produk Regular D</div><div class="text-[12px] font-black text-emerald-600 mt-1">Rp 120.000</div>
                                    </div>
                                </div>
                            </div>
