...
<div class="max-w-7xl mx-auto pb-12 space-y-8">
    ...
    <div class="glass-panel rounded-3xl p-8 relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div class="absolute top-0 right-0 w-96 h-96 bg-emerald-500/5 dark:bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500/10 rounded-full blur-[80px] -mr-20 -mt-20 pointer-events-none"></div>
        <div class="absolute bottom-0 left-0 w-64 h-64 bg-indigo-500/5 dark:bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500/10 rounded-full blur-[60px] -ml-20 -mb-20 pointer-events-none"></div>

        <div class="relative z-10 flex items-center gap-5">
            <div class="w-16 h-16 rounded-2xl bg-emerald-50 dark:bg-emerald-500/10 border border-blue-200 dark:border-emerald-500/30 flex items-center justify-center text-emerald-600 dark:text-emerald-400 shadow-sm">
        ...
        <div class="relative z-10 bg-slate-50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-700/50 px-6 py-4 rounded-2xl flex items-center gap-4">
            ...
            <div>
                ...
                <div class="text-sm font-bold text-slate-800 dark:text-white">Tumbuh Bersama Helix</div>
            </div>
        </div>
    </div>
        ...
        <div class="lg:col-span-4 space-y-6">
            ...
            <div class="glass-panel rounded-[2rem] p-8 relative overflow-hidden group">
                ...
                <div class="space-y-3 relative z-10 border-t border-slate-200 dark:border-slate-700/50 pt-6">
                    ...
                    <div class="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-900/40 rounded-2xl border border-slate-200 dark:border-slate-700/50">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 rounded-xl bg-blue-100 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-500 flex items-center justify-center"><i class="mdi mdi-shopping text-xl"></i></div>
                ...
                <div class="glass-panel rounded-[2rem] p-6 relative overflow-hidden border-l-4 
                    ...
                    <div class="flex items-start gap-4 mb-4">
                        ...
                        @elseif($pengajuan->status == 'revision')
                            <div class="w-12 h-12 rounded-2xl bg-blue-100 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-blue-200 dark:border-emerald-500/20 flex items-center justify-center text-2xl shrink-0"><i class="mdi mdi-file-document-edit-outline"></i></div>
                            <div>
                                <div class="text-base font-black text-slate-900 dark:text-white mb-0.5">Butuh Revisi</div>
                                <div class="text-xs font-medium text-emerald-600 dark:text-emerald-400 mb-1">Tindakan Diperlukan</div>
                            ...
                            <div class="p-6 rounded-[1.5rem] border {{ $cardBg }} card-hover-effect relative overflow-hidden">
                                ...
                                <div class="flex justify-between items-start mb-5 relative z-10">
                                    <div class="flex items-center gap-3">
                                        ...
                                        @elseif($key == 'pesanan') 
                                            <div class="w-10 h-10 rounded-xl bg-blue-100 dark:bg-emerald-500/10 flex items-center justify-center"><i class="mdi mdi-shopping text-emerald-600 dark:text-emerald-500 text-xl"></i></div>
