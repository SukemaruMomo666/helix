...
<div class="min-h-screen bg-slate-50 p-4 md:p-6 lg:p-8 font-sans text-slate-900 pb-32">
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-sm font-medium text-slate-500 mt-0.5 flex items-center gap-2">
                    <a href="{{ route('seller.shop.settings') }}" class="hover:text-emerald-600 transition-colors">Pengaturan</a>
    ...
    <div x-data="securityApp()" class="max-w-2xl mx-auto">
        ...
        <div x-show="step === 1" x-transition.opacity.duration.500ms class="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm text-center">
            <div class="w-24 h-24 bg-emerald-50 text-emerald-600 rounded-full flex items-center justify-center mx-auto mb-6 border-8 border-white shadow-sm">
        ...
        <div x-show="step === 2" style="display: none;" x-transition.opacity.duration.500ms class="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm text-center">
            ...
            <div class="flex flex-col items-center gap-4">
                <button type="button" @click="verifyOtp" :disabled="loading || otp.join('').length < 6" class="w-full sm:w-auto px-10 py-3.5 bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 hover:from-emerald-700 hover:via-blue-700 hover:to-orange-600 text-white font-bold rounded-2xl shadow-lg shadow-blue-600/30 transition-all flex items-center justify-center gap-2 outline-none disabled:opacity-50 disabled:cursor-not-allowed">
                ...
                <p class="text-xs font-bold text-slate-500">Belum menerima email? <button type="button" @click="sendOtp" class="text-emerald-600 hover:text-blue-800 focus:outline-none">Kirim Ulang</button></p>
            </div>
        </div>
