...
<div class="min-h-screen bg-slate-50 p-4 md:p-6 lg:p-8 font-sans text-slate-900 space-y-6">
    ...
    {{-- 2. SECURITY ALERT --}}
    <div class="bg-emerald-50 border border-blue-200 border-l-4 border-l-blue-600 p-5 rounded-2xl flex items-start gap-4 shadow-sm mb-8">
        <i class="mdi mdi-shield-check text-2xl text-emerald-600 leading-none"></i>
        <div>
        ...
        <div class="lg:col-span-8">
            ...
            @if($toko->rekening_bank && $toko->nomor_rekening)
                ...
                <div class="bg-white border border-slate-200 rounded-3xl p-6 md:p-8 shadow-sm hover:shadow-md hover:border-slate-300 transition-all duration-300 relative overflow-hidden group">
                    ...
                    <div class="absolute top-0 left-0 w-1.5 h-full bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500"></div>
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                        ...
                        <div class="flex items-center gap-5">
                            ...
                            <div>
                                ...
                                <div class="font-mono text-xl font-black text-emerald-600 tracking-[0.2em] mb-1">
            ...
            @else
                ...
                <button type="button" onclick="openBankModal('add')" class="w-full bg-slate-50 hover:bg-emerald-50 border-2 border-dashed border-slate-300 hover:border-blue-400 rounded-3xl p-10 flex flex-col items-center justify-center text-slate-500 hover:text-emerald-600 transition-all duration-300 group">
            ...
            <div id="modalPanel" class="relative transform overflow-visible rounded-3xl bg-white text-left shadow-2xl transition-all opacity-0 scale-95 duration-300 w-full sm:max-w-lg border border-slate-200">
                ...
                <form action="{{ route('seller.finance.bank.update') }}" method="POST" id="formBank">
                    ...
                    <div class="bg-slate-50 px-6 py-5 border-b border-slate-100 flex items-center justify-between rounded-t-3xl">
                        <h3 class="text-lg font-black text-slate-900 flex items-center gap-2"><i class="mdi mdi-bank-plus text-emerald-600"></i> Rincian Rekening</h3>
