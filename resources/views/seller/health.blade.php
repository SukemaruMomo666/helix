        ...
        <div class="lg:col-span-4 space-y-6">
            ...
            <div class="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
                <div class="flex justify-between items-center border-b border-slate-100 pb-4 mb-5">
                    ...
                    <a href="#" class="text-xs font-bold text-emerald-600 hover:text-blue-800 transition-colors">Riwayat <i class="mdi mdi-chevron-right"></i></a>
                </div>
                        ...
                        @elseif($appeal && $appeal->status === 'ditolak')
                            ...
                            <form action="{{ route('account.appeal') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="alasan_banding" rows="4" class="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-xs font-bold focus:ring-2 focus:ring-emerald-500 outline-none transition-all" placeholder="Jelaskan bukti perbaikan yang telah Anda lakukan..."></textarea>
                                </div>
                                <div>
                                    <label class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2">Bukti Pendukung (Opsional)</label>
                                    <input type="file" name="bukti_pendukung" class="w-full text-xs font-bold text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-[10px] file:font-black file:bg-emerald-50 file:text-blue-700 hover:file:bg-blue-100">
                                </div>
                        ...
                        @else
                            <form action="{{ route('account.appeal') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea name="alasan_banding" rows="4" class="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-xs font-bold focus:ring-2 focus:ring-emerald-500 outline-none transition-all" placeholder="Jelaskan alasan mengapa penangguhan ini harus ditinjau kembali..."></textarea>
                                </div>
                                <div>
