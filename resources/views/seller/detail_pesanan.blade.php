...
@section('title', 'Rincian Pesanan - Helix')
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500 font-medium ml-11">
                No. Invoice: <span class="text-emerald-600 font-bold uppercase">{{ $transaksi->kode_invoice }}</span> 
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 items-start pb-6 border-b border-gray-100 last:border-0 last:pb-0">
                        ...
                        <div class="flex-1 w-full">
                            ...
                            <div class="mt-4 flex flex-wrap gap-2">
                                ...
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-emerald-50 text-blue-700 text-[11px] font-bold uppercase tracking-wider border border-blue-100">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-6 relative overflow-hidden">
                ...
                <h3 class="text-sm font-black text-gray-800 uppercase tracking-wide mb-4"><i class="fas fa-user-circle text-emerald-500 mr-2"></i> Info Pelanggan</h3>
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="border-t border-dashed border-gray-200 pt-3 mt-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-black text-emerald-600 text-lg">Rp {{ number_format($grandTotalToko, 0, ',', '.') }}</span>
                        </div>
                    </div>
                </div>
                    ...
                    @if($transaksi->tipe_pembayaran == 'DP')
                        <div class="bg-orange-50 border border-orange-200 rounded-xl p-4 mt-3">
                            <div class="flex justify-between items-center mb-2">
                                <span class="text-xs font-bold text-orange-700"><i class="fas fa-handshake mr-1"></i> Sistem UMKM Uang Muka (DP)</span>
