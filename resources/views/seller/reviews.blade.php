            ...
            <div class="divide-y divide-slate-100">
                @foreach($reviews as $review)
                    <div class="p-6 flex flex-col sm:flex-row gap-5 hover:bg-slate-50/50 transition-colors">
                        ...
                        {{-- Avatar Pembeli --}}
                        <div class="w-12 h-12 rounded-full bg-emerald-50 text-emerald-600 border border-blue-100 flex items-center justify-center font-black text-lg flex-shrink-0 uppercase">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            @if(!empty($review->balasan_penjual))
                                <div class="bg-emerald-50/50 border-l-4 border-l-blue-600 p-4 rounded-r-xl mt-2">
                                    <div class="text-[11px] font-black text-emerald-600 uppercase tracking-widest flex items-center gap-1.5 mb-2">
