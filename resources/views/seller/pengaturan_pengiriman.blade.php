...
<div class="min-h-screen bg-slate-50 pb-24 font-sans text-slate-800">
        ...
        <div class="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
                <h1 class="text-2xl font-black text-slate-900 tracking-tight flex items-center gap-3">
                    <i class="mdi mdi-truck-fast text-emerald-600 text-3xl"></i> Layanan Pengiriman
                </h1>
    ...
    <div class="max-w-6xl mx-auto px-4 md:px-10 mt-8">
        ...
        <div class="bg-emerald-50 border border-blue-200 rounded-xl p-5 mb-8 flex items-start gap-4 shadow-sm">
            <i class="mdi mdi-information text-emerald-600 text-2xl mt-0.5"></i>
            <div>
                <h5 class="text-sm font-bold text-blue-900 mb-1">Strategi Pengiriman Produk UMKM</h5>
                            ...
                            <label class="service-tile w-full">
                                ...
                                <div class="service-content">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <span class="text-xs font-medium text-slate-500">Kirim produk berat dengan armada mandiri Anda.</span>
                                    </div>
                                    <i class="mdi mdi-check-circle check-icon"></i>
                                </div>
                            </label>
                            ...
                            <label class="service-tile w-full mt-4">
                                ...
                                <div class="service-content !border-amber-200 hover:!border-amber-400">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <span class="text-xs font-medium text-slate-500">Sanggup mengirim produk hari itu juga dengan tarif ekstra.</span>
                                    </div>
                    ...
                    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden relative">
                        <div class="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                            <div class="flex items-center gap-3 opacity-50">
                                <div class="w-8 h-8 rounded bg-blue-100 text-emerald-600 flex items-center justify-center"><i class="mdi mdi-cube-send"></i></div>
                    ...
                    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
                        ...
                        <div class="px-6 py-4 border-b border-slate-100 bg-indigo-50/50 flex justify-between items-center">
                            <div class="flex items-center gap-3">
                                <div class="w-8 h-8 rounded bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 text-white flex items-center justify-center"><i class="mdi mdi-api"></i></div>
                                <div>
                                    <h3 class="text-base font-bold text-slate-800 m-0">Ekspedisi Nasional</h3>
                                    <p class="text-[10px] font-bold text-emerald-600 uppercase tracking-widest m-0">Powered by Biteship</p>
                                </div>
                            </div>
...
<div class="save-bar">
    <button type="submit" form="mainLogisticsForm" class="px-8 py-3 bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 hover:from-emerald-700 hover:via-blue-700 hover:to-orange-600 text-white text-sm font-bold rounded-xl shadow-lg shadow-blue-500/30 transition-all outline-none flex items-center gap-2">
            ...
            <div id="modalPanel" class="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl transition-all opacity-0 scale-95 duration-300 border border-slate-200">
                <form action="{{ route('seller.pengaturan.pengiriman.store') }}" method="POST" id="kurirForm">
                    ...
                    <div class="bg-slate-50 px-6 py-4 border-t border-slate-200 flex justify-end gap-3">
                        ...
                        <button type="submit" class="px-6 py-2.5 bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 hover:from-emerald-700 hover:via-blue-700 hover:to-orange-600 text-white font-bold rounded-xl shadow-sm text-sm transition-colors outline-none">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
