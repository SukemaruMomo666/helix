...
<head>
    ...
    <title>Keranjang Belanja - Helix</title>
    ...
    <main class="flex-grow max-w-[1400px] mx-auto w-full px-4 lg:px-8 py-8 lg:py-12">
        ...
        <div class="mb-10 animate-fade-in-up text-center flex flex-col items-center">
            <h1 class="text-4xl lg:text-5xl font-black text-zinc-900 leading-tight tracking-tighter">
                Keranjang <span class="text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 italic">Belanja.</span>
            </h1>
            <p class="text-sm font-medium text-zinc-500 mt-3 max-w-lg mx-auto">
                Periksa kembali produk UMKM Anda sebelum melakukan checkout.
            </p>
        </div>
        ...
        @if(isset($is_guest) && $is_guest)
            <div class="bg-white rounded-[2.5rem] shadow-sm border border-zinc-100 p-12 text-center animate-fade-in-up flex flex-col items-center justify-center min-h-[500px] relative overflow-hidden">
                ...
                <p class="text-zinc-500 font-medium max-w-md mb-10 relative z-10">Anda harus masuk ke akun Helix Anda terlebih dahulu untuk melihat dan mengelola keranjang belanja.</p>

                <a href="{{ route('login') }}" class="group relative bg-zinc-950 hover:bg-gradient-to-r hover:from-emerald-500 hover:via-blue-500 hover:to-orange-500 text-white font-black py-4 px-10 rounded-2xl transition-all duration-500 shadow-xl hover:shadow-emerald-500/25 hover:-translate-y-1 overflow-hidden z-10">
        ...
        @elseif(isset($groupedCart) && $groupedCart->isEmpty())
            <div class="bg-white rounded-[2.5rem] shadow-sm border border-zinc-100 p-12 text-center animate-fade-in-up flex flex-col items-center justify-center min-h-[500px] relative overflow-hidden">
                ...
                <div class="w-24 h-24 bg-white border border-zinc-100 rounded-[2rem] flex items-center justify-center mb-8 relative z-10 shadow-premium">
                    <i class="fas fa-shopping-basket text-4xl text-emerald-500"></i>
                </div>
                <h2 class="text-3xl font-black text-zinc-900 tracking-tight mb-3 relative z-10">Keranjang Masih Kosong</h2>
                <p class="text-zinc-500 font-medium max-w-md mb-10 relative z-10">Mulai eksplorasi ribuan produk UMKM terbaik untuk kebutuhan Anda.</p>

                <a href="{{ route('produk.index') }}" class="group relative bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 text-white font-black py-4 px-10 rounded-2xl transition-all duration-500 shadow-xl hover:shadow-emerald-500/30 hover:-translate-y-1 overflow-hidden z-10">
                    ...
                    <div class="bg-white rounded-[2rem] border border-zinc-100 p-5 flex items-center gap-4 shadow-sm">
                        <label class="flex items-center gap-4 cursor-pointer group">
                            <div class="relative flex items-center justify-center shrink-0">
                                ...
                                <div class="w-6 h-6 rounded-lg border-2 border-zinc-200 peer-checked:bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 peer-checked:border-blue-600 transition-all duration-300 flex items-center justify-center group-hover:border-blue-400">
                                        ...
                                        <div class="flex gap-5 shrink-0">
                                            <label class="flex items-start mt-8 cursor-pointer">
                                                <div class="relative flex items-center justify-center shrink-0">
                                                    ...
                                                    <div class="w-6 h-6 rounded-lg border-2 border-zinc-200 peer-checked:bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 peer-checked:border-blue-600 transition-all duration-300 flex items-center justify-center hover:border-blue-400">
                                                        <i class="fas fa-check text-white text-xs opacity-0 peer-checked:opacity-100 scale-50 peer-checked:scale-100 transition-all duration-300"></i>
                                                    </div>
                                                </div>
                                            </label>
                        ...
                        <div class="bg-white rounded-[2.5rem] shadow-premium border border-zinc-100 p-8 relative overflow-hidden">
                            ...
                            <div class="space-y-4 mb-6 text-sm relative z-10">
                                <div class="flex justify-between items-center text-zinc-500 font-medium">
                                    <span>Total Produk (<span id="summary-count" class="font-bold text-zinc-900">0</span>)</span>
                            ...
                            <div class="mb-8 border-t border-zinc-100 pt-6 relative z-10">
                                <span class="text-[10px] font-black text-zinc-900 uppercase tracking-widest mb-3 flex items-center gap-1.5">
                                    <i class="fas fa-ticket-alt text-emerald-500"></i> Makin Hemat Pakai Promo
                                </span>
                                ...
                                <div id="voucher-input-box" class="flex items-center gap-2">
                                    ...
                                    <button type="button" onclick="applyVoucher()" id="btn-apply-voucher" class="bg-zinc-900 hover:bg-gradient-to-r hover:from-emerald-500 hover:via-blue-500 hover:to-orange-500 text-white px-5 py-3.5 rounded-xl font-black transition-colors shadow-md text-[10px] uppercase tracking-widest shrink-0 w-[100px] flex justify-center items-center">
                                        Terapkan
                                    </button>
                                </div>
                                ...
                                <div id="applied-voucher-tag" class="hidden mt-3 items-center justify-between bg-blue-50 border border-blue-200 px-3 py-2 rounded-lg">
                                    <div class="flex items-center gap-2">
                                        <div class="w-6 h-6 rounded-full bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 flex items-center justify-center text-white text-[10px]">
                            ...
                            <div class="pt-6 border-t border-zinc-100 border-dashed mb-8 relative z-10">
                                <div class="flex justify-between items-end">
                                    ...
                                    <span id="summary-total-price" class="text-3xl lg:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 tracking-tighter leading-none price-transition">Rp0</span>
                                </div>
                            </div>

                            {{-- Tombol Checkout Desktop --}}
                            <button type="submit" id="btn-checkout-desktop" class="hidden lg:flex group relative w-full bg-zinc-950 hover:bg-gradient-to-r hover:from-emerald-500 hover:via-blue-500 hover:to-orange-500 text-white font-black py-5 rounded-[1.5rem] transition-all duration-500 shadow-xl hover:shadow-emerald-500/25 hover:-translate-y-1 items-center justify-center gap-2 overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-zinc-950 disabled:hover:translate-y-0 disabled:hover:shadow-none relative z-10">
                                <div class="absolute inset-0 w-full h-full bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:animate-shimmer"></div>
    ...
    @if(isset($groupedCart) && !$groupedCart->isEmpty() && !(isset($is_guest) && $is_guest))
        <div class="fixed bottom-0 left-0 w-full bg-white/90 backdrop-blur-xl border-t border-zinc-200 p-5 pb-safe shadow-bottom-nav z-50 lg:hidden flex items-center justify-between gap-4">
            <div class="flex flex-col flex-1 min-w-0">
                ...
                <span id="mobile-summary-total" class="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 tracking-tighter truncate price-transition">Rp0</span>
            </div>
            <button type="button" onclick="submitCheckoutForm()" id="btn-checkout-mobile" class="w-auto px-8 bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 text-white font-black py-4 rounded-2xl active:scale-95 transition-transform disabled:opacity-50 disabled:cursor-not-allowed text-xs uppercase tracking-widest shadow-lg shadow-emerald-500/30">
                Checkout
            </button>
        </div>
    @endif
