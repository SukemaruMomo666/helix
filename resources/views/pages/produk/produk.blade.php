...
@section('title', 'Katalog Produk - Helix')
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 mb-10">
                ...
                @empty
                    ...
                    <div class="col-span-full bg-white rounded-[2rem] border border-zinc-100 py-20 flex flex-col items-center justify-center text-center px-4">
                        ...
                        <h3 class="text-2xl font-black text-zinc-900 mb-2">Produk Tidak Ditemukan</h3>
                        <p class="text-sm font-medium text-zinc-500 max-w-md mb-6">Maaf, kami tidak dapat menemukan produk dengan filter yang Anda pilih. Silakan sesuaikan kriteria pencarian Anda.</p>
                        <a href="{{ route('produk.index') }}" class="bg-black hover:bg-emerald-600 text-white font-bold py-3 px-8 rounded-xl transition-all">
                            Lihat Semua Produk
                        </a>
                    </div>
                @endforelse
