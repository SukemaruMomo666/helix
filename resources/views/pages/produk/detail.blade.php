...
<head>
    ...
    <meta charset="UTF-8">
    <title>{{ $product->nama_barang }} - Helix</title>
            ...
            <div class="w-full lg:col-span-5 space-y-10">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-1">
                        ...
                        @endif
                        <div class="text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 tracking-tighter">
                            ...
                            @foreach([5, 4, 3, 2, 1] as $star)
                                ...
                                <div class="flex items-center gap-3 group">
                                    ...
                                    <div class="flex-1 h-2 bg-zinc-100 rounded-full overflow-hidden border border-zinc-200/50">
                                        <div class="h-full bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 rounded-full transition-all duration-1000 group-hover:brightness-110" style="width: {{ $percent }}%"></div>
                                    </div>
                ...
                <div class="bg-white rounded-[2rem] sm:rounded-[2.5rem] border border-zinc-100 p-6 sm:p-8 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.05)] relative overflow-hidden">
                    ...
                    <form id="formTambahKeranjang" class="space-y-6" action="">
                        ...
                        <div class="py-5 border-t border-zinc-100">
                            ...
                            <div class="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 tracking-tighter price-transition" id="subtotalDisplay">
                                Rp{{ number_format($hargaFinal, 0, ',', '.') }}
                            </div>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <button type="button" id="btnBeliLangsung" class="group relative w-full py-4 bg-gradient-to-r from-emerald-500 via-blue-500 to-orange-500 text-white rounded-2xl font-black text-xs uppercase tracking-widest overflow-hidden shadow-lg shadow-blue-600/30 transition-all hover:brightness-110 active:scale-95">
