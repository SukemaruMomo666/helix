...
<head>
    ...
    <title>Syarat & Ketentuan - Helix B2B</title>
        ...
        <div class="px-8 py-6 border-b border-zinc-100 flex items-center justify-between bg-white">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-xs font-semibold text-zinc-400 uppercase tracking-widest mt-1">Helix Enterprise</p>
                </div>
            </div>
            ...
            <div class="p-8 bg-white">
                <div class="relative rounded-2xl border border-zinc-200 bg-zinc-50 overflow-hidden group">
                    ...
                    <div id="tnc-content" class="h-[400px] overflow-y-auto tnc-scrollbar p-6 md:p-8 text-sm text-zinc-600 leading-relaxed space-y-6 relative">
                        ...
                        <p>Selamat datang di Helix. Dengan mendaftar dan menggunakan layanan B2B e-commerce Helix, Anda secara otomatis menyetujui seluruh syarat dan ketentuan yang berlaku di bawah ini. Harap membaca dengan saksama sebelum melanjutkan proses pendaftaran akun perusahaan Anda.</p>
                        
                        <h2 class="text-lg font-black text-black">2. Akun dan Keamanan</h2>
                        <p>a. Anda bertanggung jawab penuh untuk menjaga kerahasiaan kata sandi akun perusahaan Anda.<br>b. Helix tidak bertanggung jawab atas kerugian yang ditimbulkan akibat kelalaian pengguna dalam menjaga akses akun.<br>c. Setiap akun yang didaftarkan harus mewakili entitas bisnis (B2B) yang sah secara hukum di Indonesia.</p>
                        ...
                        <p>Helix berhak sewaktu-waktu mengubah, menambah, atau menghapus bagian dari Syarat & Ketentuan ini. Perubahan akan diinformasikan melalui email terdaftar atau notifikasi dasbor.</p>
