...
<head>
    ...
    <meta charset="UTF-8">
    <title>Checkout Aman - Helix</title>
                        ...
                        <div class="mb-8 bg-zinc-50 border border-zinc-200 p-4 rounded-xl">
                            ...
                            <div class="relative w-full">
                                <select name="tipe_pengambilan" id="tipe_pengambilan" class="w-full bg-white border border-zinc-300 text-zinc-800 text-sm font-bold rounded-xl focus:border-blue-500 px-4 py-3.5 outline-none cursor-pointer appearance-none shadow-sm">
                                    <option value="kurir">🚀 Pengiriman Instan Ekspedisi (Biteship - Grab)</option>
                                    <option value="armada">🚚 Pengiriman oleh Armada Toko Lokal</option>
    ...
    <script>
        ...
        async function triggerShippingFetch() {
            ...
            stores.forEach(store => {
                ...
                // FORCE GRAB UNTUK SEMENTARA SESUAI PERMINTAAN
                const url = `/api/cek-ongkir?tipe=${tipe}&toko_id=${tokoId}&origin=${originAreaId}&destination=${destinationAreaId}&weight=${weight}&couriers=grab&dest_lat=${destLat}&dest_lng=${destLng}`;
