...
<head>
    ...
    <title>Pulihkan Sandi - Helix B2B</title>
        ...
        <div class="w-full max-w-md my-auto animate-fade-in-up pb-10">
            ...
            <div class="mb-8 mt-4 lg:mt-0">
                <div class="inline-flex items-center justify-center p-2.5 bg-zinc-100 rounded-xl mb-6 shadow-sm lg:hidden">
                    <img src="{{ asset('assets/image/Helix.com.png') }}" alt="Logo" class="h-8 w-auto object-contain" onerror="this.outerHTML='<div class=\'text-black font-black text-xl px-2\'>P<span class=\'text-blue-600\'>.</span></div>'">
                </div>
            ...
            <div class="mt-12 pt-8 border-t border-zinc-100 flex flex-col sm:flex-row items-center justify-between gap-4">
                <span class="text-[10px] font-black text-zinc-400 uppercase tracking-widest">Helix Auth</span>
