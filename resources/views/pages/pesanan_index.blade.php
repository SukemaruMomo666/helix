...
<head>
    ...
    <title>Manajemen Pesanan - Helix</title>
        ...
        <div class="mt-16 bg-zinc-950 rounded-[3rem] p-10 lg:p-14 relative overflow-hidden shadow-2xl">
            ...
            <div class="relative z-10 grid md:grid-cols-2 gap-8 items-center">
                <div>
                    ...
                    <p class="text-zinc-400 text-sm font-medium leading-relaxed">Hubungi Customer Service resmi Helix jika Anda menemui kendala dalam pesanan atau komplain material.</p>
                </div>
                <div class="flex flex-wrap gap-3 md:justify-end">
                    <a href="mailto:support@helix.com" class="bg-white/5 border border-white/10 text-white font-bold py-2.5 px-6 rounded-xl hover:bg-white/10 transition-colors text-xs flex items-center gap-2"><i class="fas fa-envelope"></i> Email Support</a>
