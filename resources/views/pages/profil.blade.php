...
<head>
    ...
    <meta charset="UTF-8">
    <title>Profil Saya - {{ $user->nama }} | Helix</title>
                ...
                <div id="section-banding" class="bg-white rounded-[2rem] shadow-soft border-2 border-amber-100 p-6 sm:p-8">
                    ...
                    @if($appeal && $appeal->status === 'pending')
                        <div class="bg-amber-50 border border-amber-200 rounded-2xl p-6 text-center">
                            ...
                            <p class="text-sm font-medium text-amber-700">Admin Helix sedang meninjau alasan dan bukti Anda. Mohon tunggu dalam 1x24 jam.</p>
                        </div>
