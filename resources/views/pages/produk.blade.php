...
<head>
    ...
    <meta charset="UTF-8">
    <title>Katalog Produk - Helix</title>
    ...
    <div class="bg-white border-b border-zinc-100 hidden md:block">
        <div class="max-w-[1400px] mx-auto px-4 lg:px-8 py-4">
            <nav class="flex text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 items-center gap-3">
                ...
                <span class="text-zinc-900">Katalog Produk</span>
            ...
            <div id="product-grid" class="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 relative z-0 mb-10">
                ...
                @empty
                    ...
                    <div class="col-span-full flex flex-col items-center justify-center py-24 bg-white rounded-[2rem] border border-zinc-100 shadow-sm mt-2">
                        ...
                        <h3 class="text-xl sm:text-2xl font-black text-zinc-900 mb-2">Produk Tidak Ditemukan</h3>
                        <p class="text-zinc-500 text-sm font-medium text-center max-w-sm mb-8 px-4">Maaf, produk dengan kriteria filter tersebut tidak tersedia. Coba gunakan filter lain.</p>
                        <a href="{{ route('produk.index') }}" class="bg-zinc-950 hover:bg-emerald-600 text-white font-black py-3.5 px-8 rounded-xl transition-all shadow-md">
