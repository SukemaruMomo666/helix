    ...
    <main class="container mx-auto px-4 sm:px-6 py-8 lg:py-12 space-y-16 lg:space-y-24 relative z-20">
        ...
        <section class="w-full">
            ...
            <div class="flex flex-wrap items-center justify-center gap-6 md:gap-12 text-sm font-medium text-slate-600">
                <div class="flex items-center gap-2"><i class="fas fa-store text-teal-600"></i> 100% Produk Lokal</div>
                <div class="flex items-center gap-2"><i class="fas fa-star text-teal-600"></i> Kualitas Terjamin</div>
                <div class="flex items-center gap-2"><i class="fas fa-handshake text-teal-600"></i> Dukung UMKM</div>
            </div>
        </section>
        ...
        <section class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                @foreach(array_slice($listToko->toArray(), 0, 3) as $index => $tokoObj)
                    ...
                    <a href="{{ route('toko.detail', ['slug' => $toko->slug ?? '']) }}" class="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all flex items-center gap-4 group">
