...
<head>
    ...
    <title>@yield('title') - Helix Admin</title>
    ...
    <style>
        ...
        .dark body {
            background: radial-gradient(circle at top left, #1e3a8a 0%, #0f172a 40%, #020617 100%);
    ...
    <div class="admin-main-wrapper">
        ...
        <footer class="mt-auto py-6 px-8 text-center">
            <p class="text-[10px] font-black text-slate-400 dark:text-slate-600 uppercase tracking-[0.3em] m-0 transition-colors duration-500">
                &copy; {{ date('Y') }} Helix Platform &bull; Core Engine v2.0
            </p>
        </footer>
    </div>
