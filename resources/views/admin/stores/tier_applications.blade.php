...
<style>
    ...
    .dark .dark\:bg-emerald-500\/5 { background-color: rgba(59, 130, 246, 0.05) !important; }
...
<div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-8">
    <div>
        ...
        <div class="flex items-center gap-2 text-xs font-bold text-slate-500 dark:text-slate-400 transition-colors duration-300">
            <a href="{{ route('admin.stores.index') }}" class="hover:text-emerald-600 dark:hover:text-blue-400 transition-colors text-decoration-none">Manajemen Toko</a>
            <i class="mdi mdi-chevron-right text-sm"></i>
            <span class="text-emerald-600 dark:text-emerald-400">Daftar Pengajuan Tier</span>
        </div>
    </div>
    <div class="bg-emerald-50 dark:bg-emerald-500/10 border border-blue-100 dark:border-emerald-500/20 px-4 py-2.5 rounded-xl flex items-center gap-3 transition-colors duration-300">
        <i class="mdi mdi-shield-check-outline text-emerald-500 text-xl"></i>
        <span class="text-xs font-bold text-blue-700 dark:text-emerald-400">Verifikasi data dan performa toko sebelum menyetujui kenaikan level.</span>
    </div>
</div>
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors duration-200">
                    ...
                    <td class="px-6 py-5">
                        <div class="flex items-center gap-2">
                            ...
                            <i class="mdi mdi-arrow-right text-emerald-500"></i>
                            <span class="text-xs font-black text-emerald-600 dark:text-emerald-400 uppercase">{{ str_replace('_', ' ', $app->tier_tujuan) }}</span>
                        </div>
                    </td>
                    <td class="px-6 py-5">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="text-[11px] font-bold text-slate-600 dark:text-slate-300 flex items-center gap-1.5">
                                <i class="mdi mdi-shopping text-emerald-500"></i> Pesanan: {{ $meta['pesanan_snapshot'] ?? '-' }}
                            </div>
                    ...
                    <td class="px-6 py-5">
                        @php
                            ...
                            elseif($st == 'revision') $stClass = 'bg-blue-100 text-blue-700 border-blue-200 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-500/20';
                    ...
                    <td class="px-6 py-5 text-center">
                        ...
                        <button class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border border-blue-100 dark:border-emerald-500/20 hover:bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 hover:text-white transition-all outline-none btn-process"
                            data-id="{{ $app->id }}"
        ...
        <div class="modal-content border-0 shadow-2xl rounded-3xl overflow-hidden dark:bg-slate-900 dark:border-slate-700">
            ...
            <form id="formProcess" method="POST">
                ...
                <div class="modal-body p-6">
                    <div class="bg-emerald-50 dark:bg-emerald-500/5 border border-blue-100 dark:border-emerald-500/20 rounded-2xl p-4 mb-5">
                        <strong class="text-[10px] font-black text-emerald-600 dark:text-emerald-400 uppercase tracking-widest block mb-2">Catatan Penjual:</strong>
                ...
                <div class="modal-footer bg-slate-50 dark:bg-slate-800/50 border-t dark:border-slate-700 p-4">
                    ...
                    <button type="submit" class="px-6 py-2.5 rounded-xl bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 text-white text-xs font-black shadow-lg hover:from-emerald-700 hover:via-blue-700 hover:to-orange-600 transition-all">Simpan Keputusan</button>
                </div>
            </form>
        </div>
    </div>
