...
<div class="flex flex-col h-full w-full bg-transparent text-slate-700 dark:text-slate-300 relative overflow-hidden transition-colors duration-500">
    ...
    <div class="p-5 border-b border-slate-200/60 dark:border-slate-800 relative z-20 flex-shrink-0 bg-slate-50/30 dark:bg-transparent transition-colors duration-500">
        <div class="flex items-center gap-3 group">
            <div class="w-11 h-11 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-emerald-600 dark:text-emerald-400 font-black shadow-sm dark:shadow-none relative group-hover:scale-105 transition-all duration-300">
    ...
    <div class="flex-1 overflow-y-auto hide-scrollbar py-4 px-3 space-y-1 relative z-20">
        ...
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-300 outline-none text-decoration-none group relative overflow-hidden {{ request()->routeIs('admin.dashboard') ? 'bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 dark:bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 text-white font-black shadow-lg shadow-indigo-600/20' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-emerald-600 dark:hover:text-indigo-400 font-bold' }}">
...
<button @click="open = !open"
        ...
        :class="{
            'bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 dark:bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 text-white font-black shadow-lg shadow-indigo-600/20': open || {{ $isStoreActive ? 'true' : 'false' }},
            'text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-white/5 hover:text-emerald-600 dark:hover:text-indigo-400 font-bold': !(open || {{ $isStoreActive ? 'true' : 'false' }})
        }">
