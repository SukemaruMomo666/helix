...
@section('content')
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-8">
        <div>
            <h2 class="text-2xl md:text-3xl font-black text-slate-800 dark:text-white tracking-tight flex items-center gap-3 mb-1 transition-colors duration-500">
                <div class="w-10 h-10 bg-emerald-50 dark:bg-blue-900/30 border dark:border-emerald-500/20 text-emerald-600 dark:text-emerald-400 rounded-xl flex items-center justify-center transition-colors duration-500 shadow-inner">
        ...
        <div class="flex items-center gap-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 px-4 py-2.5 rounded-xl shadow-sm dark:shadow-none transition-colors duration-500">
            <i class="mdi mdi-calendar-clock text-emerald-500 dark:text-emerald-400 text-lg"></i>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5 mb-10">
        ...
        <a href="{{ route('admin.products.index', ['status' => 'pending']) }}" class="group bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:border-blue-300 dark:hover:border-emerald-500/50 rounded-[2rem] p-6 flex items-center gap-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-500/10 text-decoration-none relative overflow-hidden">
            ...
            <div class="w-14 h-14 rounded-xl bg-emerald-50 dark:bg-blue-900/40 border dark:border-emerald-500/20 text-emerald-500 dark:text-emerald-400 flex items-center justify-center text-2xl flex-shrink-0 group-hover:scale-110 transition-transform relative z-10">
            ...
            <div class="relative z-10">
                ...
                <p class="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest m-0 transition-colors duration-500">Moderasi Produk</p>
            </div>
        </a>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-10">
        ...
        <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-[2rem] p-6 shadow-sm relative overflow-hidden group hover:border-blue-200 dark:hover:border-slate-500 transition-colors duration-500">
            <div class="absolute inset-y-0 left-0 w-1.5 bg-emerald-500 dark:bg-gradient-to-b dark:from-blue-400 dark:to-indigo-500 rounded-l-2xl transition-colors duration-500"></div>
            <div class="absolute right-[-10px] bottom-[-20px] opacity-5 dark:opacity-5 group-hover:opacity-10 transition-opacity">
                <i class="mdi mdi-wallet-outline text-[100px] text-emerald-600 dark:text-white"></i>
            </div>
            ...
            <h3 class="text-2xl font-black text-emerald-600 dark:text-white mb-2 relative z-10 transition-colors duration-500 dark:text-glow-blue">Rp {{ number_format($statistik['total_penjualan'] ?? 0, 0, ',', '.') }}</h3>
        ...
        <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-[2rem] p-6 shadow-sm relative overflow-hidden group hover:border-slate-300 dark:hover:border-slate-500 transition-colors duration-500">
            ...
            <div class="flex justify-between items-start mb-4 relative z-10">
                <p class="text-[10px] font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest m-0">Toko Produk</p>
        ...
        <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-[2rem] p-6 shadow-sm relative overflow-hidden group hover:border-slate-300 dark:hover:border-slate-500 transition-colors duration-500">
            ...
            <div class="flex justify-between items-start mb-4 relative z-10">
                <p class="text-[10px] font-bold text-slate-400 dark:text-slate-400 uppercase tracking-widest m-0">Total Produk</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-10">
        ...
        <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-[2rem] p-6 shadow-sm flex flex-col transition-colors duration-500">
            ...
            <div class="flex-1 flex flex-col gap-4 justify-center">
                ...
                <div class="bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-700 p-4 rounded-2xl hover:border-blue-200 dark:hover:border-emerald-500/50 transition-colors group">
                    <div class="flex justify-between items-center mb-2">
                        <span class="text-[10px] font-black text-slate-400 dark:text-slate-400 uppercase tracking-widest">Estimasi Muatan</span>
                        <i class="mdi mdi-weight-kilogram text-emerald-500 dark:text-emerald-400 text-xl group-hover:scale-110 transition-transform"></i>
                    </div>
    ...
    <div class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-[2rem] shadow-sm overflow-hidden mb-8 transition-colors duration-500">
        <div class="px-6 py-5 border-b border-slate-100 dark:border-slate-700 flex justify-between items-center bg-white dark:bg-slate-800 transition-colors duration-500">
            <h3 class="text-sm font-black text-slate-800 dark:text-white transition-colors duration-500">Top Performance Toko UMKM</h3>
            <a href="{{ route('admin.dashboard.top_stores') }}" class="text-xs font-bold text-emerald-600 dark:text-white hover:text-blue-800 dark:hover:text-blue-400 transition-colors outline-none bg-emerald-50 dark:bg-slate-700 dark:hover:bg-slate-600 px-3 py-1.5 rounded-lg border-0 no-underline">Lihat Semua</a>
        </div>
