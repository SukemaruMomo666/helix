...
<form action="{{ route('admin.logistics.update') }}" method="POST" class="pb-24">
        ...
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div>
                ...
                <p class="text-slate-400 text-sm font-bold m-0 max-w-2xl leading-relaxed">
                    Atur ketersediaan ekspedisi API pihak ketiga (Biteship) yang diizinkan beroperasi di platform Helix. Kurir yang dipilih di sini akan tersedia untuk diaktifkan oleh masing-masing Penjual.
                </p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        {{-- KOLOM KIRI (ARMADA MANDIRI & METODE TOKO UMKM) --}}
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div>
                                ...
                                <div class="input-group">
                                    <input type="number" name="max_custom_fleet_distance" value="{{ $settings['max_custom_fleet_distance'] ?? '50' }}" placeholder="Cth: 50" class="form-control-input bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-800 dark:text-white focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 font-bold text-sm shadow-inner dark:shadow-none">
        ...
        <div class="lg:col-span-5 space-y-6">
            ...
            <div class="bg-white dark:bg-slate-900 border-t-4 border-t-blue-500 border-x border-b border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm transition-colors duration-300 overflow-hidden">
                <div class="p-6 border-b border-slate-100 dark:border-slate-800 bg-emerald-50/30 dark:bg-transparent">
                    <h3 class="text-lg font-black text-slate-800 dark:text-white flex items-center gap-2 m-0">
                        <i class="mdi mdi-api text-emerald-500 text-2xl"></i> Master Kurir (Biteship API)
                    </h3>
                    <div class="bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/30 p-4 rounded-xl mt-4">
                        <p class="text-[11px] font-bold text-amber-700 dark:text-amber-400 m-0 leading-relaxed text-justify">
                            ...
                            <strong>HIERARKI SISTEM:</strong> Anda sebagai Super Admin bertugas menentukan "Daftar Kurir Global" yang boleh beroperasi di platform Helix. Kurir yang Anda beri centang di bawah ini, nantinya akan muncul di <strong>Dashboard Seller</strong> agar mereka bisa memilih kurir mana saja yang cocok dengan lokasi gudang mereka.
                        </p>
                    </div>
                </div>
                                ...
                                <div class="courier-content flex flex-col justify-center p-4 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl h-full transition-colors duration-200 relative">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div class="w-10 h-10 rounded-lg bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-700 flex items-center justify-center flex-shrink-0 shadow-sm z-10">
                                            <i class="mdi {{ $kurir['icon'] ?? 'mdi-truck-delivery' }} text-emerald-500 dark:text-emerald-400 text-xl"></i>
                                        </div>
                                    ...
                                    {{-- Checkmark Overlay --}}
                                    <div class="check-icon absolute top-3 right-3 text-emerald-600 dark:text-emerald-400 opacity-0 scale-50 transition-all duration-300 z-20">
    ...
    <button type="submit" class="btn-save-floating flex items-center justify-center gap-2 px-6 py-3.5 bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 hover:from-emerald-700 hover:via-blue-700 hover:to-orange-600 text-white text-sm font-black rounded-full shadow-lg shadow-blue-600/30 hover:-translate-y-1 transition-all outline-none border border-emerald-500/50">
