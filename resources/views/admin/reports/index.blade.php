...
<div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-6">
    <div>
        ...
        <div class="flex items-center gap-2 text-xs font-bold text-slate-500 dark:text-slate-400 transition-colors duration-300">
            ...
            <span class="text-emerald-600 dark:text-emerald-400">Analitik Pendapatan</span>
        </div>
        <p class="text-[11px] font-bold text-slate-500 dark:text-slate-400 mt-2 m-0 max-w-xl leading-relaxed">
            Transparansi arus kas, perhitungan biaya potongan Payment Gateway (Midtrans), dan ringkasan laba bersih platform Helix.
        </p>
    </div>
</div>
...
<form action="{{ route('admin.reports.index') }}" method="GET" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-5 mb-8 shadow-sm transition-colors duration-300 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
    ...
    <div class="flex flex-wrap items-center gap-3 w-full xl:w-auto">
        ...
        <button type="submit" class="px-5 py-2.5 bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 hover:from-emerald-700 hover:via-blue-700 hover:to-orange-600 text-white text-xs font-black uppercase tracking-wider rounded-xl shadow-md shadow-blue-600/20 transition-all outline-none w-full sm:w-auto flex items-center justify-center gap-2">
...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
    ...
    <div class="bg-white dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/50 p-6 rounded-[2rem] shadow-sm hover-lift transition-colors duration-300 relative overflow-hidden group">
        <div class="absolute right-6 top-6 w-12 h-12 rounded-xl bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center text-2xl flex-shrink-0 group-hover:scale-110 transition-transform">
        ...
        <div class="relative z-10">
            ...
            <div class="inline-flex items-center gap-1.5 px-2.5 py-1 bg-slate-50 dark:bg-slate-800/80 border border-slate-100 dark:border-slate-700 rounded-lg text-[10px] font-bold text-emerald-600 dark:text-emerald-400 transition-colors">
...
<div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2rem] p-6 lg:p-8 mb-8 shadow-sm transition-colors duration-300">
    <div class="flex justify-between items-center mb-6">
        <h4 class="text-base font-black text-slate-800 dark:text-white flex items-center gap-2">
            <i class="mdi mdi-chart-areaspline text-emerald-500 text-xl"></i> Tren Pertumbuhan Penjualan
        </h4>
        <button class="w-8 h-8 flex items-center justify-center rounded-lg bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-400 dark:text-slate-500 hover:text-emerald-500 transition-colors outline-none">
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-800/50">
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors duration-200">
                    <td class="px-6 py-5 align-middle">
                        <span class="text-sm font-black text-emerald-600 dark:text-emerald-400 font-mono">{{ $trx->kode_invoice }}</span>
