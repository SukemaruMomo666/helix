...
<div class="space-y-4 pb-8">
    ...
    <div class="bg-white dark:!bg-slate-900 p-4 sm:p-6 rounded-2xl border border-slate-200 dark:!border-slate-700 shadow-sm flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div class="flex items-center gap-4">
            <div class="w-12 h-12 bg-indigo-50 dark:!bg-indigo-900/50 text-emerald-600 dark:!text-indigo-400 rounded-xl flex items-center justify-center border border-indigo-100 dark:!border-indigo-700">
                    ...
                    <tr class="hover:bg-slate-50 dark:hover:!bg-slate-800/80 transition-all duration-200">
                        <td class="px-5 py-4 align-middle">
                            <div class="flex flex-col gap-1">
                                ...
                                <div class="flex items-center gap-2">
                                    <span class="px-1.5 py-0.5 bg-indigo-50 dark:!bg-indigo-900/50 text-emerald-600 dark:!text-indigo-300 text-[9px] font-bold rounded uppercase border border-indigo-100 dark:!border-indigo-700/50">{{ $appeal->level }}</span>
                        ...
                        <td class="px-5 py-4 align-middle text-center">
                            @if($appeal->bukti_pendukung)
                                <a href="{{ asset('assets/uploads/appeals/' . $appeal->bukti_pendukung) }}" target="_blank" 
                                   class="inline-flex w-8 h-8 rounded-lg bg-slate-50 dark:!bg-slate-800 border border-slate-200 dark:!border-slate-600 items-center justify-center text-slate-600 dark:!text-slate-300 hover:text-emerald-600 dark:hover:!text-indigo-400 transition-colors">
                        ...
                        <td class="px-5 py-4 align-middle text-right">
                            @if($appeal->status === 'pending')
                                <button type="button" onclick='openReviewModal(@json($appeal))' class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 hover:from-emerald-700 hover:via-blue-700 hover:to-orange-600 dark:!bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 dark:hover:!bg-indigo-500 text-white text-[11px] font-bold rounded-md transition-colors border border-indigo-700">
                                    Tinjau Kasus
                                </button>
                            @else
            ...
            <form id="formProcessAppeal" method="POST" class="flex flex-col h-full overflow-hidden bg-white dark:!bg-slate-900 rounded-2xl">
                ...
                <div class="px-5 py-4 flex items-center justify-between border-b border-slate-200 dark:!border-slate-700 bg-slate-50 dark:!bg-slate-800 rounded-t-2xl shrink-0">
                    <div>
                        ...
                        <p class="text-[10px] font-bold text-slate-500 dark:!text-slate-400">ID: <span id="modalId" class="font-mono text-emerald-600 dark:!text-indigo-400">#0000</span></p>
                    </div>
                ...
                <div class="px-5 py-3 bg-slate-50 dark:!bg-slate-800 border-t border-slate-200 dark:!border-slate-700 rounded-b-2xl flex justify-end gap-2 shrink-0">
                    ...
                    <button type="submit" class="px-4 py-2 bg-gradient-to-r from-emerald-600 via-blue-600 to-orange-500 dark:!bg-indigo-500 hover:from-emerald-700 hover:via-blue-700 hover:to-orange-600 text-white text-[11px] font-bold rounded-md transition-colors border border-indigo-700">Simpan Keputusan</button>
                </div>
            </form>
        </div>
    </div>
